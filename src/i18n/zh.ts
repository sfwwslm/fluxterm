export const zh = {
  ...
  "rdp.actions.refreshProfiles": "刷新 Profile",
  ...
  "rdp.config.title": "RDP 配置",
  "rdp.searchPlaceholder": "检索会话或分组",
  "rdp.widget.empty": "尚未保存 RDP Profile",
  "rdp.widget.hint": "双击一个 Profile 可在远程桌面子应用中发起连接。",
  "rdp.noMatch": "没有匹配的会话",
  "rdp.drawer.sections.connection": "会话",
  ...
  "rdp.metrics.fps": "帧率 {value} FPS",
  "rdp.metrics.resolution": "画面 {value}",
  "rdp.metrics.bridge": "桥接 {value}",
