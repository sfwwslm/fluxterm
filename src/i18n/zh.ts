export const zh = {
  ...
  "subapp.ftp.menuLabel": "文件传输 (FTP)",
  "subapp.ftp.title": "文件传输 (FTP) 子应用",
  "subapp.ftp.demoHeading": "Phase 3 子应用 Demo",
  "subapp.ftp.demoBody":
    "当前窗口用于验证 SubApp 生命周期协议：launch / ready / close-request / main-shutdown。",
  "subapp.menu.app": "应用",
