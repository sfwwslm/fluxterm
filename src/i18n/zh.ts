export const zh = {
  ...
  "error.securityEnableUnavailable": "当前已启用加密，请直接修改安全密码",
  "error.securityChangeUnavailable": "当前未启用主密码加密，无法修改安全密码",
  "error.securityUnlockUnavailable": "当前未启用主密码加密，无需解锁",
  ...
  "status.ai": "AI",
  "status.ai.unset": "未接入",
  "status.security.locked": "已锁定",
  "status.security.unlocked": "已解锁",
  "status.security.plaintext": "未加密",
