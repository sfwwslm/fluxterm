export const enUsTranslations = {
  ...
  "serial.groupLabel": "Serial",
  "serial.actions.newProfile": "New Serial Profile",
  "serial.actions.refreshPorts": "Refresh Ports",
  "serial.modal.newTitle": "New Serial Profile",
  "serial.modal.editTitle": "Edit Serial Profile",
  "serial.section.connection": "Connection",
  "serial.section.parameters": "Serial Parameters",
  "serial.section.terminal": "Terminal",
  "serial.form.port": "Port",
  "serial.form.baudRate": "Baud Rate",
  "serial.form.dataBits": "Data Bits",
  "serial.form.stopBits": "Stop Bits",
  "serial.form.parity": "Parity",
  "serial.form.flowControl": "Flow Control",
  "serial.form.lineEnding": "Send Line Ending",
  "serial.form.localEcho": "Local Echo",
  "serial.form.localEchoHint": "Echo local input in the terminal after send.",
  "serial.form.parity.none": "None",
  "serial.form.parity.odd": "Odd",
  "serial.form.parity.even": "Even",
  "serial.form.flow.none": "None",
  "serial.form.flow.software": "Software",
  "serial.form.flow.hardware": "Hardware",
  "serial.form.lineEnding.none": "None",
