export const en = {
  ...
  "rdp.actions.refreshProfiles": "Refresh Profiles",
  ...
  "rdp.config.title": "RDP Config",
  "rdp.searchPlaceholder": "Search sessions or groups",
  "rdp.widget.empty": "No saved RDP profiles yet.",
  "rdp.widget.hint":
    "Double-click a profile to connect from the remote desktop subapp.",
  "rdp.noMatch": "No matching sessions",
  "rdp.drawer.sections.connection": "Session",
  ...
  "rdp.metrics.fps": "FPS {value}",
  "rdp.metrics.resolution": "Surface {value}",
  "rdp.metrics.bridge": "Bridge {value}",
